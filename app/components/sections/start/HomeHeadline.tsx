...
export default function HomeHeadline() {
    ...
    return <>
            <div style={{backgroundImage:`url(/me_mobile.webp)`}} className={`block md:hidden [@media(max-height:600px)]:hidden bg-cover relative  h-[25vw] w-[25vw] mt-[-15vw] mb-[2vw] slideIn`}/>
